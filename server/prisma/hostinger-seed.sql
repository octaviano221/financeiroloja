...
(1, 'Administrador Sud Daiana', 'admin@suddaiana.com', '$2a$10$AIRQUqypvo.vSvuEQN4Sn.jIWIk2zV2Lx.uNyYKsFwxpJNih34IB.', 'ADMIN', true, NOW(3), NOW(3));
...
(2, 'Camiseta Básica Feminina', NULL, 'CAM-BASICA', NULL, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=600&q=80', 28.00, 59.90, NULL, 3, 'Arara principal', true, false, true, 2, 1, NOW(3), NOW(3)),
(3, 'Calça Jeans Skinny', NULL, 'JEANS-SKINNY', NULL, 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=600&q=80', 74.00, 149.90, NULL, 3, 'Arara principal', true, false, true, 3, 1, NOW(3), NOW(3));
...
(1, 'Dia das Mães 20% OFF', 'CATEGORIA', 'Vestidos', 'PERCENTUAL', 20.00, NULL, NOW(3), DATE_ADD(NOW(3), INTERVAL 30 DAY), true, NOW(3)),
